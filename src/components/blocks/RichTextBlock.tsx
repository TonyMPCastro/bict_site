    ...
    <div className="max-w-4xl mx-auto px-4 py-12 md:py-16">
      <div 
        className={`prose prose-lg dark:prose-invert max-w-none 
                   ...
                   prose-img:rounded-xl prose-img:shadow-md [&_img[style*='float:_right']]:ml-6 [&_img[style*='float:_right']]:mb-4 [&_img[style*='float:_left']]:mr-6 [&_img[style*='float:_left']]:mb-4
