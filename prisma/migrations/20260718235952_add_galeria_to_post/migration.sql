...
INSERT INTO "new_Post" ("atualizadoEm", "autorId", "categoriaId", "conteudo", "criadoEm", "dataPublicacao", "id", "imagem", "publicado", "resumo", "slug", "titulo", "visualizacoes") SELECT "atualizadoEm", "autorId", "categoriaId", "conteudo", "criadoEm", "dataPublicacao", "id", "imagem", "publicado", "resumo", "slug", "titulo", "visualizacoes" FROM "Post";
DROP TABLE "Post";
